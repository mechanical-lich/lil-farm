...
## Achievements
Sixteen of them, in a fifth tab of the bag beside the fish and the flowers.
...
- **One at a time.**  Coming back from a week away can land several at once, and three of these stacked would be a pile-up rather than a moment, so they queue and take their turn.  Anything earned during offline catch-up is shown on arrival: events are suspended while the farm fast-forwards, so the record keeps the tick each award landed on and the boot sequence reads them back.
